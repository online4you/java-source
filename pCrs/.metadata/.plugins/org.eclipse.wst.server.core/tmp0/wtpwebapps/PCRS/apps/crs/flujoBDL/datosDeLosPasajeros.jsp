...
<img id="espera" style="display:none; position:absolute; z-index: 1000; " src="<s:property value='getContextPath()'/>/static/crs/images/wait3.gif" />
...
function callPreReserva(serializedData,mostrarReservar){
 ...
 function isBannedMail( email) {
	 
	 bannedDomain="yopmail.com";
 }
	function nifOK(dni) {
