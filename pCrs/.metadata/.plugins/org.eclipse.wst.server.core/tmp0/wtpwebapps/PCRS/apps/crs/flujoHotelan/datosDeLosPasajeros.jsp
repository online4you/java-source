...
<s:form id="datosPasajeros" name="datosPasajeros" >
	<input id="hotelSeleccionadoDetail" name="hotelSeleccionado" type="hidden" value="<s:property value="getSerializedHotel(hotel)"/>"/>
    	...
    	<tr> 
        	<td align="left" class="textoDatosPago" colspan="2">
				<div style="overflow:auto; font-size: 15px; padding: 15px;">
					...
					<a href="javascript: verDesgloseIni()" style="float:right;color:#F38A12"><s:text name="lang.gen.crs.i_verDesglose"/></a>
				</div>
    ...
    <tr> 
		<td style="line-height: 24px;" colspan="2" class="colu1">
			...
			<a target="_blank" href="http://www.book-villa.com/index2.php?option=com_content&amp;view=article&amp;id=2&amp;lang=en"><s:text name="lang.gen.crs.i_acepto"/></a>
            <br> 
            ...
            <a target="_blank" href="http://www.book-villa.com/index2.php?option=com_content&amp;view=article&amp;id=6&amp;lang=en"><s:text name="lang.gen.crs.i_aceptoprivacidad"/></a> 
        </td>
     </tr>
     <tr> 
     	<td style="line-height: 24px;" colspan="2" class="colu1">
     ...
     <tr> 
     	<td height="10" colspan="2" align="center">
     		 <button id="botonReserva" onclick="javascript:verDesglose();" class="botonReserva" type="button"><s:text name="lang.gen.glo.reservar"/></button>
     	</td>
     </tr>
</tbody>
</table>
...
<div id="desglosePreciosIni" class="preloading_white_content" >
		...
		<tr>
			<td colspan="4">
				<div class="art-PostMetadataHeader">
					<h2 class="art-PostHeader" style="text-align:center"><s:property value="hotel.name"/></h2>
				</div>
			</td>
		</tr>
		<tr>
...
<tr>
		...
		<tr>
			...
			<td colspan="1">
				<span style="color:#178EB6;font-weight:bolder"><s:text name="lang.gen.glo.Adultos"/>:</span><span style="color:#000000">&nbsp;<s:property value="adults"/></span>
			</td>
				<td colspan="1">
					<span style="color:#178EB6;font-weight:bolder"><s:text name="lang.gen.glo.ninos"/>:</span><span style="color:#000000">&nbsp;<s:property value="ninos"/></span>
				</td>
			<td colspan="1">
				<span style="color:#178EB6;font-weight:bolder"><s:text name="lang.gen.crs.i_bebes"/>:</span><span style="color:#000000">&nbsp;<s:property value="bebes"/></span>
			</td>
			<td colspan="1">&nbsp;</td>
		</tr>
	...
	<tr>
		...
		<td colspan="1" style="text-align:right">
			<span style="color:#000000"><s:property value="twoDecimalFormat(getGastosCancelacion())"/>&nbsp;EUR</span>
		</td>
	</tr>
	<tr>
		<td colspan="1"><span style="color:#178EB6;font-weight:bolder"><s:text name="lang.gen.crs.i_fechaGastos"/>*:</span></td>
		<td colspan="1">
			<span style="color:#000000"><s:property value="formatDate(getFechaGastos())"/></span>
		</td>
		<td colspan="2">&nbsp;</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td colspan="1" style="text-align:right">
			<span style="color:#000000"><s:property value="twoDecimalFormat(hotel.priceBigDecimal)"/>&nbsp;EUR</span>
		</td>
	</tr>
	...
	<tr>
		...
		<td colspan="1" style="text-align:right">
			<span style="color:#000000;font-weight:bolder"><s:property value="twoDecimalFormat(getGastosCancelacion())"/>&nbsp;EUR</span>
		</td>
	</tr>
	<s:if test='aPagarDesde()'>
		<tr>
			<td colspan="3"><span style="color:#178EB6;font-weight:bolder"><s:text name="lang.gen.crs.i_aPagarAntesDe"/>&nbsp;<s:property value="formatDate(getFechaGastos())"/>:</span></td>
			<td colspan="1" style="text-align:right">
				<span style="color:#000000;font-weight:bolder"><s:property value="twoDecimalFormat(hotel.priceBigDecimalNoComision)"/>&nbsp;EUR</span>
			</td>
		</tr>
	</s:if>
	<tr>
	...
	<tr>
		<td colspan="4">* <s:text name="lang.gen.glovilla.gastosCancelacionPortVill"/></td>
	</tr>
	<tr>
		<td colspan="4">&nbsp;</td>
	</tr>
	...
	<tr>
		<td colspan="4" align="center">
				<button id="botonCancelar" onclick="javascript:cierraDesgloseIni();" class="botonReserva" type="button"><s:text name="lang.gen.crs.i_cerrar"/></button>
		</td>
	</tr>
</table>
</div>
...
<div id="desglosePrecios" class="preloading_white_content" >
...
<s:form id="processForm" name="processForm" >
	...
	<input id="adults" name="adults" type="<s:property value='#debug'/>" value="<s:property value='adults'/>"/>
	<input id="ninos" name="ninos" type="<s:property value='#debug'/>" value="<s:property value='ninos'/>"/>
	<input id="bebes" name="bebes" type="<s:property value='#debug'/>" value="<s:property value='bebes'/>"/>
 ...
 <script type="text/javascript">
	...
	function verDesgloseIni(){
		$j('#desglosePreciosIni').show();
		var pos=$j('#factura').offset();
    	var oWith=$j("#desglosePreciosIni").outerWidth();	
    	var oHeight=$j("#desglosePreciosIni").outerHeight();
    	var left=pos.left;
    	var top=pos.top;
    	
    	left=100;
    	
 		$j("#desglosePreciosIni").css( { "left":(left) + "px", "top":(top) + "px" } ); 
 		$j('#espera').hide();
		$j('#desglosePreciosIni').show();
	}
...
function chaeckNIF(nif){
	...
	function goToPago(){
		...
		var urlTransfer='<s:property value="getContextPath()"/>/apps/portvill/pagoTransfer.html';
		var url='<s:property value="getContextPath()"/>/apps/portvill/pago.html';
		
		if ($j('#typeOfPaymentID').val()=='2'){
			url=urlTransfer;
		}
		var str = "<form name='f1' method='post' target='_self' action='"+urlTransfer+"'>";
	...
	function cierraDesgloseIni(){
		$j('#desglosePreciosIni').hide();
		if (parent.location != window.location) {
			eval("parent.autoResize('iframeResultados');");
		}
	}
