...
function cambiaZona(zcodi,znombre) {
	...
	url="cargaHoteles.asp?ide="+ide+"&lang="+lang+"&idz="+zcodi+"&idtipo="+idtipo;
...
function cambiaTipo(Tcodi,Tnombre) {
	...
	url="cargaHoteles.asp?ide="+ide+"&lang="+lang+"&idz="+idz+"&idtipo="+Tcodi;
...
function abreCalendar(esaFecha){
	...
	var ide=document.getElementById("ide").value;
	var lang=document.getElementById("lang").value;
	laurl="calendario.asp?ide="+ide+"&lang="+lang+"&elForm=fb&valor="+esaFecha+"&"+esaFecha+"="+lafecha;
...
function abreCalendarDispo(ese,hotel,habi,mesIni,anyIni){
	...
	laurl="calendarioDispo.asp?ide="+ide+"&lang="+lang+"&idh="+hotel+"&codhab="+habi+"&mesI="+mesIni+"&anyI="+anyIni;
