...
HTMLArea.Config = function () {
  ...
  this.pageStyleSheets = ["/maqueta/estilos.css"];

  // specify a base href for relative links
  this.baseHref  = "http://www.planetaweb.es";
  ...
  this.stripBaseHref = false; //true //vte;
...
HTMLArea.prototype._createLink = function(link) {
  ...
  if (!link) {
    ...
    if (compare == 0) {
      alert("Necesita seleccionar un texto para crear un enlace");
      return;
    }
    outparam = {
      f_href : '',
    ...
    outparam = {
	  ...
	  f_class : link.getAttribute("class"),
      f_usetarget : editor.config.makeLinkShowsTarget
    };
