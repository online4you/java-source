...
public abstract class BaseGenScriptsSitePK implements Serializable, IGenScriptsSitePK {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.photel.data.gen.ddbb.hibernate.pojo.GenScriptsSitePK)) return false;
		else {
			com.photel.data.gen.ddbb.hibernate.pojo.GenScriptsSitePK mObj = (com.photel.data.gen.ddbb.hibernate.pojo.GenScriptsSitePK) obj;
