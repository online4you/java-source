...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td><div align="center" style="font-size:large;font-weight:bold;color:#CCCCCC;font-family: Helvetica, sans-serif;">No hay archivos</div></td>
  </tr>
</table>
<?	
}
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td><div align="center" style="font-size:small;font-weight:bold;color:#CC0000;font-family: Helvetica, sans-serif;">Problema de configuración: &quot;<? echo $BASE_DIR.$BASE_ROOT; ?>&quot; no existe.</div></td>
  </tr>
</table>
<?	
}
...
<html>
<head>
<title>Explrador imágenes</title>
...
{
	if(numFiles > 0) {
		alert("Hay "+numFiles+" archivos/carpetas en \""+folder+"\".\n\nPor favor, borre todos los archivos/carpetas en \""+folder+"\" primero.");
		return false;
	}

	if(confirm("Borrar carpeta \""+folder+"\"?")) 
		return true;
