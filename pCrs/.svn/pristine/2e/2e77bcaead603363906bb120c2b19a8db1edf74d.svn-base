	        ...
	        <table width="99%" align="center" border="0" cellspacing="2" cellpadding="2">
			  ...
			  <select name="path" id="path" style="width:35em" onChange="changeDir(this)">
				  <option value="/">/</option>
					  ...
					  <a href="#" onClick="javascript:goUpDir();"><img src="images/btnFolderUp.gif" width="15" height="15" border="0" alt="Subir"></a></td>
	<?php if ($MY_ALLOW_CREATE_FOLDER) { ?>
	                  <!-- td><div class="separator"></div></td>
	                  <td class="buttonOut" onMouseOver="pviiClassNew(this,'buttonHover')" onMouseOut="pviiClassNew(this,'buttonOut')">
					  <a href="#" onClick="javascript:newFolder();"><img src="images/btnFolderNew.gif" width="15" height="15" border="0" alt="Nueva carpeta"></a></td -->
	<?php } ?>
	                </tr>
	              </table></td>
	          </tr>
