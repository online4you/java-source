      ...
      <table border="0" align='left' cellpadding="0" cellspacing="0">
        <tr> 
          <td align="left" width="760"> <!--#include file="seleccionado.asp"--> <table align='center' border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-top:10px">
              <tr>
                <td align='right'> <input type='button' class="boton145" value='<%=objIdioma.getTraduccionHTML("i_todosloshoteles")%>' onclick="javascript:window.location='<%=MiPag%>?todos=-1&cp=<%=compara%>';"> 
                  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Compara 
                  con año: 
		...
		if hayestemesP then
			...
			elxml="<graph caption='" & titulo & "' subcaption='" & objIdioma.getTraduccionHTML("i_importespormes") & "' xAxisName='" & ucase(objIdioma.getTraduccionHTML("i_totalimporteanyo")) & " " & any & ": " & formatnumber(totalIReservas,0) & " €' yAxisName='" & objIdioma.getTraduccionHTML("i_importe") & "' decimalPrecision='0' formatNumberScale='0' bgColor='DCDCDC' canvasBgColor='F0E7C3' canvasBaseColor='E7BD06' decimalSeparator=',' thousandSeparator='.' formatnumber='1' chartRightMargin='0'>"
            ...
            <script type="text/javascript">
			   var chart = new FusionCharts("fusion/FCF_MSColumn3D.swf", "Importes", "760", "400");
		...
		%>
            ...
            <script type="text/javascript">
		   var chart = new FusionCharts("fusion/FCF_Column3D.swf", "Reservas", "650", "350");
		   chart.setDataXML("<%=elxml%>");		   
		...
		%>
            ...
            <script type="text/javascript">
		   var chart = new FusionCharts("fusion/FCF_Column3D.swf", "Dias", "650", "350");
		   chart.setDataXML("<%=elxml%>");		   
		...
		%>
            ...
            <script type="text/javascript">
		   var chart = new FusionCharts("fusion/FCF_Column3D.swf", "Media", "650", "350");
		   chart.setDataXML("<%=elxml%>");		   
