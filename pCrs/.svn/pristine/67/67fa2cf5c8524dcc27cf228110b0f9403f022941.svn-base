...
cs=cs & "Dto,Precio,isnull(dbo.fnGetTraduccion('Ofertas','Titulo',Ofertas.Id,'"&lang&"'),ISNULL(Ofertas.Titulo,'')) 'Titulo',isnull(dbo.fnGetTraduccion('Ofertas','Texto',Ofertas.Id,'"&lang&"'),ISNULL(Ofertas.Texto,'')) 'Texto',NochesGratis,DiasSemana FROM Ofertas "
