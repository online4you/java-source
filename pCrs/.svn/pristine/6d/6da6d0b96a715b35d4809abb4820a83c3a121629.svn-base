...
<form name="f1" method="post" action="<%=MiPag%>">
			<table width='100%' align='center' border="0" cellpadding="0" cellspacing="0" class="tdTabla">
			  <tr><td align='center' class="tituloTabla">GALERÍA FOTOS HOTEL<b><%=ucase(nhotel)%></b></td>
			  </tr>
			  <tr><td valign="top" align="center">
					...
					<tr><td align='center'>
						...
						<iframe align='top' frameborder="0" height="340"  hspace="0" vspace="0" width="710" src="FotosHotel.asp?idf=<%=laid%>&otravez=1&ver=<%=ver%>">
						</iframe>
					</td></tr>					
					</table>
