<%
		...
		PrecioHab(dia)=0
		PrecioPlazas(dia)=0
		cs="SELECT Preprebase,Preperhab,isnull(dbo.fnGetTraduccion('TipoHabitaNombres','Nombre',TipoHabitaNombres.Id,'"&lang&"'),ISNULL(TipoHabitaNombres.Nombre,'')) 'Nombre',ParaCapNormal "
