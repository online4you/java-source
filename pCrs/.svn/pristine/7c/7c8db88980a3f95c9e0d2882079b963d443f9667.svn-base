...
do while not rs.eof
	select case rs("CodigoColec")
		case colecninos2 'niños2
			ninosextra=0
			'response.Write("desdePlazas=" &rs("desdePlazas")& "<br>")
			'response.Write("cuantosNinos1=" &cuantosNinos1& "<br>")
			'response.Write("ninos2=" &ninos2& "<br>")
			'response.Write("ninos1=" &ninos1& "<br>")
			if (rs("desdePlazas")>cuantosNinos1 or rs("hastaPlazas")=0) then
				if rs("desdePlazas")=0 AND rs("hastaPlazas")=0 then 'no usa el sistema de 2º niño
