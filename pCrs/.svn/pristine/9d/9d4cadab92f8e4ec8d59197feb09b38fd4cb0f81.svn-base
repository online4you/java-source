...
/**
* HTMLArea3 XTD addon - ImageManager
...
<head>
<title>Añadir/editar imagen</title>
...
function onOK() {
  var required = {
    "f_url": "Por favor, escriba la dirección URL o escoja una imagen."
  };
...
<div class="title">Añadir/editar imagen</div>
...
<div id="loading" style="position:absolute; left:200px; top:130px; width:184px; height:48px; z-index:1" class="statusLayer">
  <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td><div align="center"><span id="loadingStatus" class="statusText">Cargando imágenes</span><img src="ImageManager/dots.gif" width="22" height="12"></div></td>
    </tr>
  </table>
</div>
...
?>
				  ...
				  <a href="#" onClick="javascript:goUpDir();"><img src="ImageManager/btnFolderUp.gif" width="15" height="15" border="0" alt="Subir"></a></td>
<? if ($SAFE_MODE == false) { ?>
<? } ?>
                </tr>
              </table></td>
    ...
    <tr>
      <td><table border="0" align="center" cellpadding="2" cellspacing="2">
          ...
          <td><div align="right">Subir:</div></td>
            ...
            <td><div align="right">Alineación:</div></td>
            <td colspan="2"><select name="align" ID="f_align">
                <OPTION id="optNotSet" value="" SELECTED>Predeterminado</OPTION>
                <OPTION id="optLeft" value="left">Izquierda</OPTION>
                <OPTION id="optRight" value="right">Derecha</OPTION>
                <OPTION id="optTop" value="top">Superior</OPTION>
                <OPTION id="optTexttop" value="textTop">Texto superior</OPTION>
                <OPTION id="optMiddle" value="middle">Medio</OPTION>
                <OPTION id="optAbsMiddle" value="absMiddle">Medio absoluta</OPTION>
                <OPTION id="optBottom" value="bottom">Inferior</OPTION>
                <OPTION id="optBaseline" value="baseline">Línea base</OPTION>
                <OPTION id="optAbsBottom" value="absBottom">Inferior absoluta</OPTION>
              </select></td>
            <td><div align="right">Borde:</div></td>
          ...
          <tr> 
            ...
            <td colspan="5">Conservar relación de aspecto:</td>
          </tr>
        </table>
    ...
    <tr>
      <td>
      	<table width="100%" border="0" cellpadding="0" cellspacing="0">
      		...
      		<tr>
      			<td><button type="button" name="ok" onclick="return refresh();">Refrescar</button></td>
      			<td align="right"><button type="button" name="ok" onclick="return onOK();">Aceptar</button>&nbsp;&nbsp;<button type="button" name="cancel" onclick="return onCancel();">Cancelar</button></td>
      		</tr>
      	</table>
     </td>
    </tr>
