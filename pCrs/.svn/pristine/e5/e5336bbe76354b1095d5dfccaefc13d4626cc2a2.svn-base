...
<div class="title">Crear/editar hipervínculo</div>
<form action="" method="get">
<table border="0" style="width:100%;">
  <tr>
    <td class="label" valign="top" nowrap>Escoja un artículo:</td>
    <td><?php echo $select; ?></td>
  </tr>
  <tr>
  <td colspan="2" align="center">o alternativamente:</td>
  </tr>
  <tr>
    <td class="label"><nobr>Escriba la URL:</nobr></td>
    <td><input type="text" id="i_href" style="width: 100%;" /></td>
  </tr>
  <tr>
    <td class="label" nowrap>Título (optional):</td>
    <td><input type="text" id="i_title" style="width: 100%" /></td>
  </tr>
  <tr>
    <td class="label" nowrap>Marco de destino:</td>
    <td><select id="i_target">
      <option value="">Por defecto</option>
      <option value="_blank">Nueva ventana (_blank)</option>
      <option value="_self">Mismo marco (_self)</option>
      <option value="_top">Toda la página (_top)</option>
    </select>
