...
if request.form<>"" then 'Actualizar
	...
	diasAdelanto=paClng(request.form("diasAdelanto"))
	...
	if msgerror="" then 'procesar
		select case modo 
			case "nuevo" 'Añadir
				...
				cs=cs & "DiasSemana,Destacada,NochesGratis,Calcula,Activa,Caduca,CodigoPromocion,Valida) VALUES ('"
