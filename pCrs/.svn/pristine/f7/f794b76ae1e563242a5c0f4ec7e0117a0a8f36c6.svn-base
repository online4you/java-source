...
class clsListadoZonas
	...
	private sub estructuraZonas(IdPadre,nivel,idioma)
		...
		cs="SELECT Zonas.Id, IIF(ISNULL(traduc.Traduccion),Zonas.Zona,traduc.Traduccion) AS Tradu, Zonas.IdPadre "
...
if mysqlBD then 'es mysql
	...
	Conecta="Driver={MySQL ODBC 5.1 Driver};Server=" & conexBD & ";Database=" & nombreBD & ";Uid=" & userBD & ";Pwd=" & pwdBD & ";ODBC database; Option = 3"
else 'sql Server
