...
<div style="margin: 0 auto;width:775px" id="contenedor" >
	<div style="font-family:Verdana,Arial,Helvetica,sans-serif;font-size:1.6em;" id="contenido">
		...
		<div id="detallesviaje">
			...
			<div style="width: 141px;float:left;text-align:center;background-color:#FFF">
				<img src="<s:property value="getContextPath()"/>/static/main/images/common1024/icoadv.gif"/>
			</div>
			<div style="height:134px;" class="tabladetalles16">
				<div style="height:auto;" class="tabdetalleviajecabecera">
					<span id="SPNERRORCONFIRM1" class="texto_2"><s:property value="getText('lang.gen.pantallaError.errorServicio')"/></span>
				</div>
				<div style="height:30px;" class="limpiar"></div>
			  	<div style="width:600px;" class="columna02">
					<div class="etiqueta1">
						<span id="SPNERRORCONFIRM2" class="texto_16"><s:property value="getText('lang.gen.pantallaError.textoErrorServicio')"/></span>
					</div>
