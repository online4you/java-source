...
public class PagoSabadell extends MainAction {
	...
	private final String urlCeca = URL_SAB;
	...
	public synchronized String executeHalconAction() throws Exception {
		...
		//para depurar en local datosTPV[0]="http://82.223.216.227:8080/";
		...
		String merchantUrlKO = datosTPV[0] + this.getContextPath()		+ datosTPV[2] + "?idReserva=" + idReserva + "&request_locale="
				+ this.getLocale().getLanguage();
