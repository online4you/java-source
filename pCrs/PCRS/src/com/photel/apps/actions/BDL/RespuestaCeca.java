...
public class RespuestaCeca extends MainAction {
	...
	public String executeHalconAction() throws Exception {
		...
		try{
			...
			String locata=num_operacion;
			num_operacion=num_operacion.split("-")[1];
		
		
			HibernateReservas res = this.service.getReservaHotelanFromLocata(locata);
			...
			this.service.getIrqVillaConfirmReservation(num_operacion, res.getHlCs());
			...
			//guillempuigros@gmail.com
			this.service.sendVoucherHotelan(idi, "", locata);
