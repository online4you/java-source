...
public interface IGenStylesSite {

	/**
	 * Return the unique identifier of this class
	 * @hibernate.id
	 */
	public abstract IGenStylesSitePK getId();

	/**
	 * Set the unique identifier of this class
	 * @param id the new ID
	 */
	public abstract void setId(IGenStylesSitePK id);
