...
public abstract class BaseGenImagesSitePK implements Serializable, IGenImagesSitePK {
	...
	public boolean equals (Object obj) {
		...
		if (!(obj instanceof com.photel.data.gen.ddbb.hibernate.pojo.GenImagesSitePK)) return false;
		else {
			com.photel.data.gen.ddbb.hibernate.pojo.GenImagesSitePK mObj = (com.photel.data.gen.ddbb.hibernate.pojo.GenImagesSitePK) obj;
