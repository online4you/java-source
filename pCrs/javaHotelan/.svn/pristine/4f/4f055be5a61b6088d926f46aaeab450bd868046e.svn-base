 ...
 * generated in the com.photel.hotelan.client.IrqHotelDetailsList package. 
 ...
 */
@XmlRegistry
public class IrqHotelDetailsListObjectFactory {
    ...
    private final static QName _Acces_QNAME = new QName("", "Acces");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.photel.hotelan.client.IrqHotelDetailsList
     * 
     */
    public IrqHotelDetailsListObjectFactory() {
    }
    ...
    /**
     * Create an instance of {@link IrqHotelDetailsListResponse }
     * 
     */
    public IrqHotelDetailsListResponse createResponse() {
        return new IrqHotelDetailsListResponse();
    }
     ...
     * 
     */
    @XmlElementDecl(namespace = "", name = "Acces")
    public JAXBElement<String> createAcces(String value) {
        return new JAXBElement<String>(_Acces_QNAME, String.class, null, value);
    }
