...
public class Hotel {
    ...
    @XmlElement(name = "Rooms", required = false)
    protected String rooms;
    @XmlElement(name = "Pax", required = false)
    ...
    @XmlElement(name = "Acces", required = true)
    ...
    /**
     * Sets the value of the acces property.
     * 
     * @param value
     *     allowed object is
     *     {@link String }
	...
	public void setPax(String value) {
		this.pax = value;
	}
